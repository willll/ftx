...
int cd_set_sector_size_internal(int size)
{
    cd_sector_size = size;
...
int cd_auth()
{
    ...
    for (;;)
    {
        ...
        if (cd_status.status == STATUS_PAUSE)
        {
            break;
        }
        else if (cd_status.status == STATUS_FATAL)
        {
...
int cd_stop_drive()
{
    ...
    for (;;)
    {
        ...
        if (cd_status.status == STATUS_STANDBY)
        {
            break;
        }
        else if (cd_status.status == STATUS_FATAL)
