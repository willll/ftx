...
void fatfs_show_details(struct fatfs *fs)
{
    ...
    FAT_PRINTF((" Sectors Per Cluster = %d", fs->sectors_per_cluster));
}
//-----------------------------------------------------------------------------
...
#ifdef SC_SATURN
/* Q&D definition of function declared in sc_saturn.c. */
